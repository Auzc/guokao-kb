...
- 判断推理适合系统课打框架 + 分题型提纯正确率。
- 学习顺序可按图形、定义、类比、逻辑推进；但若逻辑基础弱，可前移逻辑专项。
- 主流通用样本显示：刘文超系统课是常见统一入口，适合先建立完整方法体系。

## 样本支持度

- 高频课程样本：bilibili-liuwenchao-panduan。
- 路径样本：guide-common-xingce-order。
- 结论可信度：高（入口一致性较强）。
