...
- 优先完成资料分析基础闭环：速算技巧 -> 公式体系 -> 真题精讲。
- 若备考时间有限，先保证每天 1 篇资料分析限时训练，再扩展到全真套卷。
- 主流通用样本显示：刘文超基础课 + 高照实战课为高频组合，覆盖理解方法和提速应用。

## 样本支持度

- 高频课程样本：bilibili-liuwenchao-ziliao、bilibili-gaozhao-ziliao。
- 路径样本：guide-common-xingce-order（资料分析优先级最高）。
- 结论可信度：高（多来源一致）。
